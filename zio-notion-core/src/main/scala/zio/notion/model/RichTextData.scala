...
object RichTextData {
  ...
  object Mention {
    ...
    object MentionData {
       ...
       *
       * object TemplateMention { sealed trait TemplateMentionData
       *
       * object TemplateMentionData { final case class TemplateMentionDate(templateMentionDate: String) final case object TemplateMentionUser extends
       * TemplateMentionData } } */
